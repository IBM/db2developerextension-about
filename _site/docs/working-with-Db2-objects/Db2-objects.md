...
# Exploring table object details {#working-with-objects}
...
1. Under the database connection, click the specific schema that contains the table.
2. Click the table name you want to view. It displays the following table details:
   ...
   **Properties**: General details such as table name, schema name, type, encoding scheme, owner, etc.
   ...
   - Encoding scheme: Character encoding used for text data in the table (e.g., UTF-8).
...
>**Note**: The **Max rows** specifies the maximum number of rows to display in the data preview. The default value is set to 1000. You can enter desired value in the **Max rows** and click **Apply** to refresh the data view and show the number of rows entered in the **Max rows** field.
