...
2. Find the timestamp group you want to inspect and click it to display the **Execution Summary**.

   Execution summary displays the following details:


   ![Run multiple queries]({{site.baseurl}}/assets/images/execution-summary.png)
   ...
   - Connection: Shows the database connection used for execution, including the alias and host information.
   - Metric:
    - Number of statements executed: Total count of SQL statements that were part of this execution batch.
    ...
    - Warning: Number of statements that executed with warnings (e.g., non-critical issues).
    - Total elapsed time (ms): The cumulative time taken to execute all statements in the group, in milliseconds.

3. Expand the timestamp group to show individual statements. Select a statement entry. The editor displays two tabs:
   ...
   - **Status** tab shows the following details:
        ...
        ![Run multiple queries]({{site.baseurl}}/assets/images/query-history-status.png)
        ...
        - Connection: Shows the database connection details used for execution, including the alias and IP address.
        ...
        - SQL state: A five-character alphanumeric code that conforms to the SQL standard for error reporting.
    ...
    - **Result** tab displays the output of the executed SQL statement in a tabular format. It provides information about the rows returned, execution time, and options for searching and exporting results.
        ...
        ![Run multiple queries]({{site.baseurl}}/assets/images/query-history-result.png)
...
Warning and failure icons indicate which statements might need some debugging. To cycle through all of the statements that failed, click the Next Failure icon and the next failing SQL statement is displayed.
