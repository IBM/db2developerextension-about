...
2. Expand the **Views** section and click the view name. It displays the following view details:
   ...
   **Data**: Displays the preview of the actual data returned by the view.
   ...
   >**Note**: The **Max rows** specifies the maximum number of rows to display in the data preview. You can enter the desired value in the **Max rows**  and press Enter to refresh the data view with that number of rows.
   {: .note-right}
