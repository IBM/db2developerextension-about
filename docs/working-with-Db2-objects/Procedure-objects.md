...
1. Click the connection and then the schema you want.
2. Expand the **Procedures** section and click the procedure name. It displays the following procedure details:
