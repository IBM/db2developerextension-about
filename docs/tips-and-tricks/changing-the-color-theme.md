...
1. Open Db2 Developer Extension and click the **Settings** icon at the lower left corner of VS Code window:
...
3. Select any of the available themes:
   ...
   ![Selecting a color theme]({{site.baseurl}}/assets/images/tips-tricks-color-theme.mov)
